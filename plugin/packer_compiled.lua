...
_G.packer_plugins = {
  ...
  ["cellular-automaton.nvim"] = {
    loaded = true,
    path = "/Users/sean/.local/share/nvim/site/pack/packer/start/cellular-automaton.nvim",
  ...
  harpoon = {
    loaded = true,
    path = "/Users/sean/.local/share/nvim/site/pack/packer/start/harpoon",
  ...
  ["rose-pine"] = {
    loaded = true,
    path = "/Users/sean/.local/share/nvim/site/pack/packer/start/rose-pine",
  ...
  ["vim-terraform"] = {
    loaded = true,
    path = "/Users/sean/.local/share/nvim/site/pack/packer/start/vim-terraform",
